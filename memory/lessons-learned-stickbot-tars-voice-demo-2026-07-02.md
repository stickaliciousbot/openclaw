...
Do not start M7/STT, live provider/Gateway smoke, Android, persistent service install, or host-PC Tailscale proxy/user-testing exposure without separate owner approval and a fresh threat model.
