...
M7C then passed as the usable local demo model upgrade. Run `655d2910` / `tide-mist` created M7C smoke harness, updated package checks, ran `39/39 PASS`, acquired `ggml-small.en.bin` under `/home/stickai/stickbot-voice/stt_models/whisper.cpp/` SHA256 `c6138d6d58ecc8322097e0f987c32f1be8bb0a18532a3f88f734d1bbf9c41e5d` bytes `487614201`, and passed `/api/stt` with `whisper-cli` + FFmpeg normalization: HTTP 200, `normalizedLocal:true`, transcript chars `45`, transcript SHA256 `44b7adbb95a5d4d7129029ad17b4b2cc1bc3429e1b9057f3ad3640ef234a2fac`, normalized audio SHA256 `2cdd6e22cbf67805f03d275881955edfa7cd8deada3b818e7fff827010fab4ad`, no network required during transcription, network blocked/unavailable in sandbox, secret dirs hidden, no cloud/WebSpeech/OpenClaw/Gateway/NOA mutation. Classification: `STICKBOT_TARS_M7C_SMALL_EN_USABLE_DEMO_PASS`.

Do not start M7D real mic local demo, M8, live provider/Gateway smoke, Android, persistent service install, or host-PC Tailscale proxy/user-testing exposure without separate owner approval and a fresh threat model.
