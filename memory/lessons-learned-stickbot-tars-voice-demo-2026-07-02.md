...
Do not start real STT engine acquisition/install, M8, live provider/Gateway smoke, Android, persistent service install, or host-PC Tailscale proxy/user-testing exposure without separate owner approval and a fresh threat model.
