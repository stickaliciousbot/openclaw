...
import { T as validateConfigObjectWithPlugins, d as readConfigFileSnapshotForWrite, i as getRuntimeConfig, o as parseConfigJson5, r as createConfigIO, u as readConfigFileSnapshot, y as resolveConfigSnapshotHash } from "./io-DALkYPF6.js";
...
import { r as replaceConfigFile } from "./mutate-oq7iHd8f.js";
import "./config-CdR7JGdN.js";
...
import { f as scheduleGatewaySigusr1Restart } from "./restart-2Mzzre-h.js";
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-D1nDbTwX.js";
import { n as ensureAuthProfileStore } from "./store-BlmNpasc.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-BNUgpUnK.js";
import { g as patchPluginSessionExtension } from "./loader-Bfm_uDYG.js";
...
import { M as isPluginJsonValue, a as getActivePluginRegistry, n as getActivePluginChannelRegistryVersion, s as getActivePluginRegistryVersion } from "./runtime-DIK27keN.js";
...
import { r as canonicalizeSpawnedByForAgent, t as loadCombinedSessionStoreForGateway } from "./combined-store-gateway-CY4HAKef.js";
...
import { t as loadSessionStore } from "./store-load-ClZl_8Y3.js";
...
import { o as updateSessionStore } from "./store-U0H27LtH.js";
import "./plugins-C729ZIvi.js";
import { a as extractDeliveryInfo, c as resolveMainSessionKeyFromConfig, i as serializeSessionCleanupResult, r as runSessionsCleanup, s as resolveSessionLifecycleTimestamps, t as purgeAgentSessionStoreEntries } from "./sessions-DrXjd_mR.js";
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-D1cxJMQl.js";
import { n as withPluginRuntimeGatewayRequestScope } from "./gateway-request-scope-BhLQLn2S.js";
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-RYnmqAOZ.js";
...
import { h as waitForEmbeddedPiRunEnd, n as abortEmbeddedPiRun, o as isEmbeddedPiRunActive } from "./runs-1hmoj7W-.js";
...
import { a as finalizeTaskRunByRunId, r as createRunningTaskRun } from "./detached-task-runtime-DkmAiPdj.js";
...
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-yvu2cBa8.js";
import { i as normalizeCronJobCreate, o as normalizeCronJobPatch } from "./openclaw-tools-DS1i7kuo.js";
import { c as listCoreToolSections, l as resolveCoreToolProfiles, o as PROFILE_OPTIONS } from "./tool-policy-shared-Ce8ZI4la.js";
import { a as resolvePluginTools, i as getPluginToolMeta, r as ensureStandalonePluginToolRegistryLoaded, t as buildPluginToolMetadataKey } from "./tools-Bl67NQH2.js";
...
import "./auth-profiles-YbbvWl1J.js";
import { n as externalCliDiscoveryForConfigStatus } from "./external-cli-discovery-C2_-l33V.js";
import { c as projectOutboundPayloadPlanForMirror, n as createOutboundPayloadPlan, t as deliverOutboundPayloads } from "./deliver-CIzTSa9Q.js";
import { N as saveExecApprovals, b as readExecApprovalsSnapshot, f as mergeExecApprovalsSocketDefaults, m as normalizeExecApprovals, s as ensureExecApprovals } from "./exec-approvals-CkE90SRZ.js";
import { a as prepareSecretsRuntimeSnapshot, i as getActiveSecretsRuntimeSnapshot } from "./runtime-BDcM22ZB.js";
import { t as resolveAgentRuntimeMetadata } from "./agent-runtime-metadata-DaATMF4G.js";
import { i as parseAbsoluteTimeMs } from "./stagger-DiXdV9go.js";
import { i as resolveCronDeliverySessionKey, r as isInvalidCronSessionTargetIdError } from "./webhook-url-BcJyCCJE.js";
import { d as listConfiguredAnnounceChannelIdsForConfig } from "./channel-plugin-ids-B7eFAYAk.js";
import { i as resolveOutboundSessionRoute, r as ensureOutboundSessionEntry, s as dispatchChannelMessageAction } from "./message-action-runner-C1c5N3x4.js";
import { a as resolveTrustedGroupId } from "./pi-tools.policy-fJ7-J3dd.js";
import { n as normalizePollInput } from "./polls-ob6K0xJr.js";
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-CWZJrGlH.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-GIJ5geIo.js";
import "./target-resolver-BOmiCz1R.js";
import { t as maybeResolveIdLikeTarget } from "./target-id-resolution-CG86_7wV.js";
import { i as resolveReplyToMode } from "./reply-threading-BdDjX0Nu.js";
import { t as buildOutboundSessionContext } from "./session-context-DL-Nmawu.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-C92ydahB.js";
import { n as validateTargetProviderPrefix, t as resolveTargetPrefixedChannel } from "./channel-target-prefix-CVQvUCKd.js";
import { r as resolveOutboundTarget } from "./targets-CvBc5iv2.js";
import { n as resolveAgentIdentity } from "./identity-BP8R7dcY.js";
import { s as clearSessionQueues } from "./queue-CdXYNeV0.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-CqMi4Ami.js";
import { r as getLatestSubagentRunByChildSessionKey } from "./subagent-registry-read-DmbLaX44.js";
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageCountAsync, o as readRecentSessionTranscriptLines, p as visitSessionMessagesAsync, u as readSessionPreviewItemsFromTranscript } from "./session-utils.fs-kQm6zjMq.js";
import { a as resolveSessionTranscriptCandidates, t as archiveFileOnDisk } from "./session-transcript-files.fs-Df1h_yYJ.js";
...
import { n as normalizeSpawnedRunMetadata, r as resolveIngressWorkspaceOverrideForSpawnedRun } from "./spawned-context-C-W0nedA.js";
import { o as loadWorkspaceSkillEntries } from "./workspace-CPzwkOry.js";
import "./skills-DkW3r_c2.js";
import { n as resolveSendPolicy } from "./send-policy-Jy9c10GQ.js";
import { n as getSpeechProvider, r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-DaN01LSd.js";
import { r as listChatCommandsForConfig } from "./commands-registry-list-Cmkm0No9.js";
import "./commands-registry-fQjYfZzp.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-CZOB1oVV.js";
import { d as getSessionCompactionCheckpoint, f as listSessionCompactionCheckpoints, u as forkCompactionCheckpointTranscriptAsync } from "./model-context-tokens-Bt7rlSw_.js";
import { n as getActiveMemorySearchManager } from "./memory-runtime-DbWTvsWK.js";
import { n as compactEmbeddedPiSession } from "./pi-embedded-DHxAJJqQ.js";
import { t as resolvePreferredSessionKeyForSessionIdMatches } from "./session-id-resolution-BhPp-pLH.js";
import { a as getPluginCommandSpecs, r as listPluginCommands } from "./commands-D2qp4St4.js";
import { t as getChannelActivity } from "./channel-activity-66yolI0h.js";
import { t as WizardCancelledError } from "./prompts-B7yMqFIm.js";
import { n as summarizeToolDescriptionText } from "./tool-description-summary-TyTJ-8tJ.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-ByFVl5CN.js";
import { i as resolveBareSessionResetPromptState, n as shouldApplyStartupContext, r as resolveBareResetBootstrapFileAccess, t as buildSessionStartupContextPrelude } from "./startup-context-DIUXzBSA.js";
import { t as movePathToTrash } from "./browser-trash-BEmiDZiT.js";
import "./browser-maintenance-t2Z1tRGV.js";
import { n as getLastHeartbeatEvent } from "./heartbeat-events-CyvC5Wc5.js";
import { r as mergeIdentityMarkdownContent } from "./identity-file-oHwS0eOq.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-CXA9Ap6_.js";
import { r as agentCommandFromIngress } from "./agent-command-BeqDuJtZ.js";
import { a as resolveNodeCommandAllowlist, n as isNodeCommandAllowed } from "./node-command-policy-CFuOBfCb.js";
import { t as safeParseJson } from "./server-json-77zkey23.js";
import { t as formatForLog } from "./ws-log-5HkRE-YB.js";
import { n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-BWrhhGG7.js";
import { r as invokeNativeHookRelay } from "./native-hook-relay-CXJmr8MI.js";
import { t as canExecRequestNode } from "./exec-defaults-CFmuVQ8D.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DruLJlOF.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-Hc7T7PnV.js";
import { t as getRemoteSkillEligibility } from "./skills-remote-BDr4Oj9r.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-FzZv-NAq.js";
import { t as resolveVisibleModelCatalog } from "./model-catalog-visibility-CE5lvwYX.js";
import { d as rejectDevicePairing, f as removePairedDevice, g as summarizeDeviceTokens, h as rotateDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, m as revokeDeviceToken, n as approveDevicePairing, o as getPendingDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-DOxUIrgy.js";
import { b as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, i as getRealtimeVoiceProvider, n as resolveConfiguredRealtimeVoiceProvider, s as REALTIME_VOICE_AGENT_CONSULT_TOOL, t as createRealtimeVoiceBridgeSession } from "./session-runtime-BPF1T1J_.js";
import { n as PROVIDER_LABELS, o as resolveUsageProviderId } from "./provider-usage.shared-AZW6xW1b.js";
import { n as createOutboundSendDeps } from "./deps-Cug5wqhV.js";
import "./agent-EI0HZ68h.js";
import { a as matchSystemRunApprovalBinding, c as toSystemRunApprovalMismatchError, n as resolveSystemRunCommandRequest, o as missingSystemRunApprovalBinding, r as buildSystemRunApprovalBinding } from "./system-run-command-8SZJdrkO.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-DVBbNPR_.js";
import { n as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-C1eoTiAx.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CwDyVqXH.js";
import "./server-constants-CAPAddfV.js";
import { c as waitForTerminalGatewayDedupe, o as readTerminalSnapshotFromGatewayDedupe, r as chatHandlers, s as setGatewayDedupeEntry } from "./chat-BUK7LXQw.js";
import { i as resolveAgentRunExpiresAtMs, r as registerChatAbortController } from "./chat-abort-BMsp3T7z.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-D4s8vNbG.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-G5FxdBK-.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-IIIUX3ay.js";
import { t as loadProviderUsageSummary } from "./provider-usage-CKZv77AT.js";
import { t as getTaskSessionLookupByIdForStatus } from "./task-[REDACTED_SECRET_LIKE_VALUE].js";
import { s as fetchClawHubSkillDetail } from "./clawhub-jBqCl1XJ.js";
import { a as loadSessionCostSummaryFromCache, c as resolveExistingUsageSessionFile, o as loadSessionLogs, r as loadCostUsageSummaryFromCache, s as loadSessionUsageTimeSeries, t as discoverAllSessions } from "./session-cost-usage-DSJOc9gd.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort } from "./auth-health-BNhULU7E.js";
import { s as performGatewaySessionReset } from "./session-reset-service-Chx9_3Aa.js";
import { c as repairDreamingArtifacts, i as previewRemHarness, l as writeBackfillDiaryEntries, n as dedupeDreamDiaryEntries, o as removeBackfillDiaryEntries, r as previewGroundedRemMarkdown, s as removeGroundedShortTermCandidates } from "./memory-core-bundled-runtime-CEIr6JK5.js";
import { s as normalizeUpdateChannel } from "./update-channels-DBapONh5.js";
import { r as lookupConfigSchema, t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-CeZMTU8i.js";
import { t as readConfiguredLogTail } from "./log-tail-c4-qzMP1.js";
import { a as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-DkOFr6i3.js";
import { t as findOverlappingWorkspaceAgentIds } from "./agent-delete-safety-BL6pY_4q.js";
import { t as buildChannelAccountSnapshot } from "./status-Dr93MEsA.js";
import { n as DEFAULT_CHANNEL_STALE_EVENT_THRESHOLD_MS, r as evaluateChannelHealth, t as DEFAULT_CHANNEL_CONNECT_GRACE_MS } from "./channel-health-policy-BP1Tg8mf.js";
import { t as installSkill } from "./skills-install-B4MgILrL.js";
import { n as readPackageVersion } from "./package-json-Bl5_fP2R.js";
import { t as getStatusSummary } from "./status.summary-DEqdgftU.js";
import "./status-CEcFH8Uw.js";
import { i as updateSkillsFromClawHub, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-CKSGjggI.js";
import { n as runGatewayUpdate, t as resolveUpdateInstallSurface } from "./update-runner-BpLCy_-U.js";
import { t as applySessionsPatchToStore } from "./sessions-patch-jzYw7dst.js";
import { t as resolveCronDeliveryPlan } from "./delivery-plan-Ba5WuHL2.js";
import { _ as resolveDeliveryTarget, n as applyJobPatch } from "./jobs-R_NBy4oz.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-fr-CzQ1D.js";
import { i as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-BDy2w-sL.js";
import { a as resolveApnsAuthConfigFromEnv, d as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as sendApnsAlert, r as normalizeApnsEnvironment, s as sendApnsBackgroundWake, t as clearApnsRegistrationIfCurrent, u as shouldClearStoredApnsRegistration } from "./push-apns-DfgdgATH.js";
import { t as resolveGatewayReloadSettings } from "./config-reload-settings-Cyiospzr.js";
import "./heartbeat-runner-K2t8sIOe.js";
import { t as consumeControlPlaneWriteBudget } from "./control-plane-rate-limit-CxF43_i7.js";
import { i as setVoiceWakeTriggers, n as normalizeVoiceWakeTriggers, r as loadVoiceWakeConfig, t as formatError$1 } from "./server-utils-BfxjpR6Y.js";
import { n as updateSystemPresence, t as listSystemPresence } from "./system-presence-DKWDOTLt.js";
import { a as validateVoiceWakeRoutingConfigInput, i as setVoiceWakeRoutingConfig, n as normalizeVoiceWakeRoutingConfig, o as isRoleAuthorizedForMethod, r as resolveVoiceWakeRouteByTrigger, s as parseGatewayRole, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-BjOuSXqi.js";
import { n as resolveSessionKeyForRun } from "./server-session-key-znQ1ja1t.js";
import { n as buildCanvasScopedHostUrl, r as mintCanvasCapabilityToken, t as CANVAS_CAPABILITY_TTL_MS } from "./canvas-capability-CPHqlNXv.js";
import { a as nodeWakeById, n as NODE_WAKE_RECONNECT_RETRY_WAIT_MS, o as nodeWakeNudgeById, r as NODE_WAKE_RECONNECT_WAIT_MS, t as broadcastPresenceSnapshot } from "./presence-events-BxKcTcSA.js";
import { t as invokeGatewayTool } from "./tools-invoke-shared-kDlYtFtY.js";
import { n as recordLatestUpdateRestartSentinel, t as getLatestUpdateRestartSentinel } from "./server-restart-sentinel-1fF_QNsZ.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-D8NKBVxz.js");
