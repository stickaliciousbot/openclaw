...
DESIGN=Path('/home/stickai/.openclaw/workspace/design/critical-apply-supervisor-ingress-m2a-r2-exact-contract-repair-2026-08-13.md')
OUT=ROOT/'FRESH-INDEPENDENT-RESULTS.json'
sys.path.insert(0,str(ROOT))
from validate_m2a_r2 import validate
