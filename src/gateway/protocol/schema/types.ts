...
export type CronValidateGuardedUpdateParams = SchemaType<"CronValidateGuardedUpdateParams">;
export type CronGuardedUpdateParams = SchemaType<"CronGuardedUpdateParams">;
