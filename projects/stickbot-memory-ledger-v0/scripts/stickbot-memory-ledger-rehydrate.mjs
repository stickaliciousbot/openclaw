...
function buildPacket() {
  ...
  const manifest = {
    ...
    currentMilestone: 'CB-L5R actions ledger redaction/provenance repair in progress; CB-L5 marker append blocked and not performed; CB-L4 pushed PASS; no authority promotion; CB-L6/M21/M22 not started',
