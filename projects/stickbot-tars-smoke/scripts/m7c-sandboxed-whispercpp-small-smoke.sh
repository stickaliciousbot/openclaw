...
TMPROOT="${TMPROOT:-/tmp/tars-m7c-boundary}"
RESULT_DIR="$PROJECT_ROOT/docs/m7-local-stt/m7c-small-en-usable-demo"
...
M7C_FIXTURE_WAV="${M7C_FIXTURE_WAV:-/home/stickai/stickbot-voice/output/m4-first-generation.wav}"

for p in "$WHISPER_BIN" "$WHISPER_MODEL" "$FFMPEG_BIN" "$FFPROBE_BIN" "$M7C_FIXTURE_WAV"; do
...
cp "$M7C_FIXTURE_WAV" "$TMPROOT/logs/fixture-input.wav"
...
printf 'M7C_SMALL_EN_USABLE_DEMO_SMOKE_START\n'
...
printf 'M7C_SMALL_EN_USABLE_DEMO_SMOKE_COMPLETE\n'
