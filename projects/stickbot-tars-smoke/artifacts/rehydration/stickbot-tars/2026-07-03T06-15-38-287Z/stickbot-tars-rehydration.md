...
Generated: 2026-07-03T06:15:38.287Z
...
- Latest classification: `STICKBOT_TARS_M7Q_TRUE_PARTIAL_LOCAL_STT_LOOP_CODE_PASS_LIVE_STT_RESTART_PENDING`
...
- Status: `STICKBOT_TARS_M7Q_TRUE_PARTIAL_LOCAL_STT_LOOP_CODE_PASS_LIVE_STT_RESTART_PENDING`
- Needs human ear: M7Q code is ready; live browser test requires HTTPS LAN demo restarted with sttMode=cli/local whisper.cpp, then Stick should test mic partials.
...
| repo | `projects/stickbot-tars-smoke/scripts/stickbot-tars-rehydrate.mjs` | yes | 351 | `79b894c39a55` |
...
| repo | `projects/stickbot-tars-smoke/public/app.js` | yes | 621 | `8346ce24eff4` |
...
| repo | `projects/stickbot-tars-smoke/state/status.json` | yes | 1325 | `6effe2cdb41a` |
...
| doc | `projects/stickbot-tars-smoke/docs/m7-local-stt/m7q-true-partial-local-stt-loop/M7Q_TRUE_PARTIAL_LOCAL_STT_LOOP_CODE_PASS.md` | yes | 105 | `21870be89be7` |
| memory | `memory/2026-07-03.md` | yes | 369 | `07fb4baa5194` |
