...
Generated: 2026-07-03T12:23:59.985Z
...
- Latest classification: `STICKBOT_TARS_AUDIO_FIRST_MULTIPLEXED_RUNTIME_HARNESS_LIVE_PASS`
...
HOST=0.0.0.0 PORT=19890 VOICE_DEMO_ALLOW_LAN=true VOICE_DEMO_HTTPS=true VOICE_DEMO_HTTPS_KEY=/home/….pem VOICE_DEMO_HTTPS_CERT=/home/stickai/stickbot-voice/certs/m7d-https/stickbot-tars-m7d-server.cert.pem LOG_DIR=/tmp/tars-live-demo bash scripts/m7d-local-real-mic-demo.sh
...
- Needs human ear: Audio-first local runtime harness is complete. Next milestone is browser/API live contract readback proof.
...
| repo | `projects/stickbot-tars-smoke/IMPLEMENTATION_NOTEBOOK.md` | yes | 703 | `a22b2f8c62a8` |
| repo | `projects/stickbot-tars-smoke/package.json` | yes | 29 | `4cb9b3362248` |
| repo | `projects/stickbot-tars-smoke/server.js` | yes | 453 | `86f7af8adae4` |
| repo | `projects/stickbot-tars-smoke/scripts/stickbot-tars-rehydrate.mjs` | yes | 365 | `cd261756905d` |
...
| repo | `projects/stickbot-tars-smoke/src/audio/production-multiplex-runtime-harness.js` | yes | 156 | `2993d1a5969b` |
...
| repo | `projects/stickbot-tars-smoke/state/status.json` | yes | 1682 | `e9d32470f391` |
| doc | `projects/stickbot-tars-smoke/docs/STICKBOT_TARS_REHYDRATION.md` | yes | 71 | `13782b5164d1` |
| doc | `projects/stickbot-tars-smoke/docs/PRODUCTION_VOICE_STREAM_ARCHITECTURE.md` | yes | 141 | `e9d8733540d6` |
...
| doc | `projects/stickbot-tars-smoke/docs/audio-first-multiplexed-production-streaming/AUDIO_FIRST_MULTIPLEXED_RUNTIME_HARNESS_LIVE_PASS.md` | yes | 139 | `e77293e4facf` |
